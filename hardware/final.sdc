...
create_generated_clock -name {m_final_soc|sdram_pll|sd1|pll7|clk[0]} -source [get_pins {m_final_soc|sdram_pll|sd1|pll7|inclk[0]}] -duty_cycle 50.000 -multiply_by 1 -phase -54.000 -master_clock {main_clk_50} [get_pins {m_final_soc|sdram_pll|sd1|pll7|clk[0]}] 
create_generated_clock -name {m_final_soc|sdram_pll|sd1|pll7|clk[1]} -source [get_pins {m_final_soc|sdram_pll|sd1|pll7|inclk[0]}] -duty_cycle 50.000 -multiply_by 1 -phase -54.000 -master_clock {main_clk_50} [get_pins {m_final_soc|sdram_pll|sd1|pll7|clk[1]}] 
